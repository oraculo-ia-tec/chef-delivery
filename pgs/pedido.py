...
async def showPedido():
    ...
    # Cria o system_prompt usando o primeiro nome
    system_prompt = f'''
    ...
    A FAC será uma referencia para suas respostas:
        ...
        - Recebemos pagamento via PIX + a taxa de entrega R$6,00 através da chave: 31998417976.
    ...
    if "messages" not in st.session_state.keys():
        st.session_state.messages = [
            {"role": "assistant", "content": 'Olá!Sou o Chef Delivery, digite abaixo oque você deseja comprar'
                                             ' hoje?'}]
