...
def showEntregador():
    ...
    with col_busca:
        busca = st.text_input("🔍 Buscar entregador", placeholder="Nome, e-mail ou WhatsApp...")
    with col_status:
    ...
    if todos:
        ...
        df = df.rename(columns={
            ...
            "horario_registro": "Horário de Registro",
            "status": "Status",
        })
    ...
    # Upload de imagem fora do form (file_uploader não funciona dentro de st.form)
    ...
    with st.form("form_novo_entregador", clear_on_submit=True):
        ...
        submit = st.form_submit_button("Cadastrar Entregador", type="primary")
