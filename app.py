    ...
    st.markdown(
        ...
        [data-testid="stAppViewContainer"] {
            background:
                ...
                linear-gradient(180deg, #030712 0%, #06111f 48%, #020617 100%);
        }

        section[data-testid="stSidebar"] {
            background:
                linear-gradient(180deg, rgba(6, 17, 31, 0.96), rgba(3, 10, 20, 0.98));
            border-right: 1px solid rgba(122,240,176,0.10);
        }
