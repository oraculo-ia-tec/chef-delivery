...
def inject_global_style() -> None:
    st.markdown(
        ...
        .login-note {padding:0.75rem 0; color:#d8e4f3; font-size:0.95rem;}
        ...
        [data-testid="stSidebar"] .stForm .stTextInput > label,
        [data-testid="stSidebar"] .stForm .stFileUploader > label {
        ...
        [data-testid="stSidebar"] .stTextInput div[data-baseweb="base-input"] {
            ...
            box-shadow: inset 0 1px 0 rgba(255,255,255,0.05), 0 0 0 1px rgba(122,240,176,0.04) !important;
        }
        ...
        [data-testid="stSidebar"] .stTextInput div[data-baseweb="base-input"]:focus-within {
            border-color: rgba(122,240,176,0.34) !important;
            box-shadow: inset 0 1px 0 rgba(255,255,255,0.08), 0 0 0 1px rgba(122,240,176,0.08), 0 0 18px rgba(0,255,170,0.12) !important;
        ...
        [data-testid="stSidebar"] .stFileUploader {
            padding: 0.75rem;
            border-radius: 18px;
            background: radial-gradient(circle at top left, rgba(122,240,176,0.08), transparent 35%), linear-gradient(180deg, rgba(10,24,43,0.90), rgba(7,18,34,0.94));
        ...
        .recover-page .stTextInput > label {
            color:#edf8ff !important;
            font-weight:700 !important;
            opacity:1 !important;
        }
        ...
        .recover-page .stButton > button, .recover-page .stFormSubmitButton > button {
        ...
        @media (max-width:768px) {.hero-title{font-size:2.15rem;} .hero-wrap{padding:1.6rem 1rem;} .top-image img{width:160px; height:160px;} .meat-grid{grid-template-columns:1fr;} .sales-ribbon{position:static; margin-top:1rem; justify-content:center;} .ticker-row{flex-direction:column; align-items:stretch;} .recover-page{padding:1.2rem; margin-top:1rem;} .recover-title{font-size:2.15rem;}}
        </style>
        """,
        unsafe_allow_html=True,
    )
...
def render_password_recovery_page() -> None:
    ...
    if st.button("Voltar para login", key="btn_back_login"):
        try:
