...
class Dizimo(ModelBase):
    ...
    culto = relationship("OraculoCulto", back_populates="dizimos")

    def __repr__(self):
        return f"<Dizimo(id={self.id}, valor_total={self.valor_total}, oraculo_culto_id={self.oraculo_culto_id})>"